        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1", new OpenApiInfo { 
                    Title = "TheaterNow", 
                    Version = "v1",
                    Description="Authentication and Authorization in App"
                });
                c.AddSecurityDefinition("Bearer", new OpenApiSecurityScheme()
                {
                    ...
                    Description = "Enter 'Bearer'[space] and then yout valid token in the next input below.\r\n\n\r\nExample: \"Bearer 12345678901234567890\""
                });
